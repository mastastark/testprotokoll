...
nicht leitfähig ist und sich dadurch, durch die Bestrahlung, Elektronen ansammeln.
Diese Elektronenansammlung variiert durch die Bestrahlung und des elektrischen
Feldes, wodurch diese Fluktuationen zustande kommen.
...
\begin{table}[H]
	\caption[Gegenüberstellung der erhaltene Zusammensetzung aus der EDX-Analyse der 10 c
		...
		Zn $\dots$ Zink                                              \\
		Sn $\dots$ Zinn                                              \\
		$P_\text{m1} \dots$ erhaltener prozentualer Anteil nach Methode 1 \\
		$P_\text{m2} \dots$ erhaltener prozentualer Anteil nach Methode 2 \\
